"""
URL configuration for vehicle_value_prediction project.
...
urlpatterns = [
    ...
    path('', mainView.index, name='index'),            # homepage
    path('index/', mainView.index, name='index2'),     # /index/ also goes home
